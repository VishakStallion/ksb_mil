                                ...
                                <nav class="mt-2">
                                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                        ...
                                        if ($act == "vendor" or $act == "addvendor" or $act == "vendorloc" or $act == "addvendorloc" or $act == "asnuser" or $act == "addasnuser" or
                                                ...
                                                or $act=="addcustomer" or $act=="labeltemplate" or $act=="addreceipe" or $act=="mrp") {
                                            $cls = 1;
                                        }
                                        ...
                                        if ($act == "qc" or $act == "gate_entry_with_asn" or $act == "gate_entry_without_asn" or $act == "rm" 
                                                ...
                                                or $act == "Routecard_entry" or $act == "Outward_picklist_generation" or $act == "gate_entry_against_osp" or $act=="transfer_order_entry" 
                                                ...
                                                <ul class="nav nav-treeview p-1 " >
                                                    ...
                                                    <?php if ($row->i6 == 1) { ?>    
                                                     ...
                                                     <?php if ($row->i11 == 1) { ?> 
                                                        ...
                                                        <li class="nav-item"><a href="transfer_order_entry"  class="nav-link <?php if ($act == "transfer_order_entry") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer Order Entry</p>  </a></li><?php } ?>
