                                ...
                                <nav class="mt-2">
                                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                                        ...
                                        if ($act == "vendor" or $act == "addvendor" or $act == "vendorloc" or $act == "addvendorloc" or $act == "asnuser" or $act == "addasnuser" or
                                                ...
                                                or $act=="addcustomer" or $act=="labeltemplate" or $act=="addreceipe" or $act=="mrp" or $act=="pallet" or $act=="addpallet") {
                                            $cls = 1;
                                        }
                                        if ($row->m1 == 1 or $row->m2 == 1 or $row->m3 == 1 or $row->m4 == 1 or $row->m5 == 1 or $row->m6 == 1 or $row->m7 == 1 or $row->m8 == 1 or $row->m9 == 1
                                                or $row->m10 == 1 or $row->m11 == 1 or $row->m16 == 1 or $row->m12 == 1 or $row->m13 == 1 or $row->m14 ==1 or $row->m15 ==1) {
                                            ?>
                                            ...
                                            <li class="nav-item has-treeview <?php if ($cls == 1) { ?>menu-open<?php } ?>">
                                                ...
                                                <ul class="nav nav-treeview p-1 " >
                                                    ...
                                                    <?php if ($row->m15 == 1) { ?>
                                                        <li class="nav-item"><a href="pallet"  class="nav-link <?php if ($act == "pallet" or $act == "addpallet") { ?>active<?php } ?>">  <i class="fa fa-chevron-circle-right"></i><p style="font-size:14px">&nbsp;&nbsp;Pallet Master</p> </a></li><?php } ?>
                                                    ...
                                                    <?php if ($row->m9 == 1) { ?>
                                                        ...
                                                        <li class="nav-item " ><a href="labeltemplate"  class="nav-link <?php if ($act == "labeltemplate") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;FG Label Upload</p>  </a></li><?php } ?>
                                        ...
                                        if ($act == "qc" or $act == "Material_Req_Entry" or $act == "gate_entry_without_asn" or $act == "rm" 
                                                or $act == "GRN" or $act == "grn_edit" or $act == "productionentry" or $act == "productionclosing" or $act == "barcodegen" 
                                                or $act == "Routecard_entry" or $act == "transfer_order_item_cancel" or $act == "transfer_order_item_cancel_list" or $act=="transfer_order_entry" 
                                                or $act == "sale_order_item_cancel_list" or $act == "dispatch_entry"  or $act == "dispatch_gate_entry" 
                                                or $act == "sale_order_item_cancel" or $act== "rejection_entry" or $act== "production_inline_rejection_entry"
                                                or $act=="rpo_item_cancel_list" or  $act=="rpo_item_cancel"  or $act=="material_issue_cancel" or $act=="dispatch_cancel" or $act=="dispatch_manual_close" or $act=="transfer_receipt" or $act=="sales_return_entry") {
                                            $cls = 2;
                                        }
                                        if ($row->i1 == 1 or $row->i2 == 1 or $row->i3 == 1 or $row->i4 == 1 or $row->i5 == 1 or $row->i6 == 1 or $row->i7 == 1 or $row->i8 == 1 or $row->i9 == 1
                                                or $row->i10 == 1 or $row->i11 == 1 or $row->i12 == 1 or $row->i13 == 1 or $row->i14 == 1 or $row->i15 == 1 or $row->i16 == 1 or $row->i17 == 1 or $row->i18 == 1 or $row->i19 == 1) {
                                            ?>
                                            ...
                                            <li class="nav-item has-treeview <?php if ($cls == 2) { ?>menu-open<?php } ?>">
                                                ...
                                                <ul class="nav nav-treeview p-1 " >
                                                    ...
                                                    <?php if ($row->i8 == 1) { ?>    <!-- Aswin 18/06/2020 -->
                                                        <li class="nav-item"><a href="Routecard_entry"  class="nav-link <?php if ($act == "Routecard_entry") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp; RPO Material Issue </p>  </a></li><?php } ?>

                                                     <?php if ($row->i3 == 1) { ?>    <!-- Aswin 18/06/2020 -->
                                                        <li class="nav-item"><a href="Material_Req_Entry"  class="nav-link <?php if ($act == "Material_Req_Entry") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp; General Material Issue </p>  </a></li><?php } ?>
                                                    ...
                                                    <?php if ($row->i6 == 1) { ?>    
                                                     ...
                                                     <?php if ($row->i12 == 1) { ?>    <!-- Anjali 15/09/2020 -->
                                                        <li class="nav-item"><a href="dispatch_entry"  class="nav-link <?php if ($act == "dispatch_entry") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sales Dispatch Entry</p>  </a></li><?php } ?>
                                                        
                                                        <?php if ($row->i13 == 1) { ?>    <!-- Anjali 29/06/2021 -->
                                                        <li class="nav-item"><a href="transfer_order_entry"  class="nav-link <?php if ($act == "transfer_order_entry") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer  Shipment</p>  </a></li><?php } ?>
                                                        
                                                        <?php if ($row->i2 == 1) { ?>    <!-- Geo 2/07/2021 -->
                                                        <li class="nav-item"><a href="transfer_receipt"  class="nav-link <?php if ($act == "transfer_receipt") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer  Receipt</p>  </a></li><?php } ?>	
                                                        
                                                        <?php if ($row->i19 == 1) { ?>   
                                                        <li class="nav-item"><a href="sales_return_entry"  class="nav-link <?php if ($act == "sales_return_entry" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sales Return Without Barcode</p>  </a></li><?php } ?>
                                                     ...
                                                     <?php if ($row->i11 == 1) { ?> 
                                                        <li class="nav-item"><a href="dispatch_cancel"  class="nav-link <?php if ($act == "dispatch_cancel") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sales Dispatch Cancel</p>  </a></li><?php } ?> 
                                                        
                                                         <?php if ($row->i14 == 1) { ?>    
                                                        <li class="nav-item"><a href="dispatch_manual_close"  class="nav-link <?php if ($act == "dispatch_manual_close") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sales Dispatch Manual Close </p>  </a></li><?php } ?>  
                                                        
                                                          

                                                        <?php if ($row->i15 == 1) { ?>    <!-- Anjali 02/07/2021 -->
                                                        <li class="nav-item"><a href="rpo_item_cancel"  class="nav-link <?php if ($act == "rpo_item_cancel" or $act == "rpo_item_cancel_list") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;RPO Item Cancel</p>  </a></li><?php } ?>
                                                      
                                                        <?php if ($row->i16 == 1) { ?>    <!-- Anjali 02/07/2021 -->
                                                        <li class="nav-item"><a href="sale_order_item_cancel"  class="nav-link <?php if ($act == "sale_order_item_cancel" or $act == "sale_order_item_cancel_list") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sale Order Item Cancel</p>  </a></li><?php } ?>

                                                        <?php if ($row->i18 == 1) { ?>    <!-- Anjali 02/07/2021 -->
                                                        <li class="nav-item"><a href="transfer_order_item_cancel"  class="nav-link <?php if ($act == "transfer_order_item_cancel" or $act == "transfer_order_item_cancel_list") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer Order Item Cancel</p>  </a></li><?php } ?>
                                  ...
                                  or $act == "rm_return_scan_report_item"
                                   or $act == "rm_return_scan_report_detailed"
                                    ...
                                    or $act == "dispatch_entry_report_detailed" 
                                     ...
                                     or $act == "transfer_entry_report"
                                    or $act == "transfer_entry_report_summary"
                                    or $act == "transfer_entry_report_detailed"
                                    or $act == "transfer_entry_report_itemwise"
                                    or $act == "transfer_picklist"
									...
									or $act=="trans_order_report" 
                                    or $act=="trans_order_report_summary" 
                                    or $act=="trans_order_report_detailed"
									
									
									or $act=="opening_stock_report" 
                                    or $act=="opening_stock_summary" 
                                    or $act=="opening_stock_detailed"
									
									or $act=="transfer_receipt_report" 
                                    or $act=="trans_receipt_report_summary" 
                                    or $act=="trans_receipt_report_detailed"
									or $act=="trans_receipt_report_itemwise"
									
									or $act=="sales_return_report" 
                                    or $act=="sales_return_report_summary" 
                                    or $act=="sales_return_report_detailed"
									or $act=="sales_return_report_itemwise"
									
                                    or $act=="material_req_report"
                                    or $act=="material_req_report_summary"
                                    or $act=="material_req_report_detailed"

                                    or $act=="general_material_issue_report"
                                    or $act=="general_material_issue_report_summary"
                                    or $act=="general_material_issue_report_detailed"
                                    or $act=="general_material_issue_picklist"

                                     or $act=="general_material_issue_scan_report"
                                    or $act=="general_material_issue_scan_report_summary"
                                    or $act=="general_material_issue_scan_report_detailed"
									
									  or $act=="general_material_item_return_report"
                                    or $act=="general_material_item_return_report_summary"
                                    or $act=="general_material_item_return_report_detailed"
                                    or $act == "general_material_item_return_report_navsend"
                                    or $act =="general_material_item_return_report_itemwise"
									
									or $act=="stockout_report_detailed"
                                    or $act == "stockout_report_summary"
                                    or $act =="stockout_report"

                                    or $act=="purchase_return_report_detailed"
                                    or $act=="purchase_return_report_summary"
                                    or $act=="purchase_return_report"

                                    or $act=="nav_detail_report"
                                    or $act=="nav_detail_report_summary"
                                    or $act=="nav_detail_report_detailed"
                                        ...
                                        if ($row->r1 == 1 or $row->r2 == 1 or $row->r3 == 1 or $row->r4 == 1 or $row->r5 == 1 or $row->r6 == 1 or $row->r7 == 1 or $row->r8 == 1 or $row->r9 == 1
                                                ...
                                                or $row->r26 == 1 or $row->r27 == 1 or $row->r28  or $row->r29 == 1 or $row->r30 == 1 or $row->r31 == 1  or $row->r32== 1  or $row->r33 == 1 or 
                                                $row->r34 == 1 or $row->r35 == 1 or $row->r36 == 1 or $row->r37 == 1 or $row->r38 == 1 or $row->r39 == 1 or $row->r40 == 1) {
                                            ?>
                                            ...
                                            <li class="nav-item has-treeview <?php if ($cls == 3) { ?>menu-open<?php } ?>">
                                                ...
                                                <ul class="nav nav-treeview p-1 " >
                                                   ...
                                                   <?php if ($row->r8 == 1) { ?>   
                                                     ...
                                                     <?php if ($row->r30 == 1) { ?>    
                                                        <li class="nav-item"><a href="purchase_return_report"  class="nav-link <?php if ($act == "purchase_return_report" or $act == "purchase_return_report_detailed" or $act == "purchase_return_report_summary") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp; Purchase Return Report </p>  </a></li><?php } ?>
                                                    ...
                                                    <?php if ($row->r4== 1) { ?>   
                                                        <li class="nav-item"><a href="material_req_report"  class="nav-link <?php if ($act == "material_req_report" or $act=='material_req_report_summary' or $act=='material_req_report_detailed') { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp; Material Requisition  Report </p>  </a></li><?php } ?>

                                                     <?php if ($row->r16== 1) { ?>   
                                                        <li class="nav-item"><a href="general_material_issue_report"  class="nav-link <?php if ($act == "general_material_issue_report" or $act=='general_material_issue_report_summary' or $act=='general_material_issue_report_detailed') { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;General Material Issue Report </p>  </a></li><?php } ?>

                                                       
                                                        <?php if ($row->r26== 1) { ?>   
                                                        <li class="nav-item"><a href="general_material_issue_scan_report"  class="nav-link <?php if ($act == "general_material_issue_scan_report" or $act=='general_material_issue_scan_report_summary' or $act=='general_material_issue_scan_report_detailed') { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;General Material Issue Scan Report </p>  </a></li><?php } ?>
                                                      
                                                       <?php if ($row->r28== 1) { ?>   
                                                        <li class="nav-item"><a href="general_material_item_return_report"  class="nav-link <?php if ($act == "general_material_item_return_report" or $act=='general_material_item_return_report_summary' or $act=='general_material_item_return_report_detailed' or $act == 'general_material_item_return_report_itemwise') { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;General Item Return Scan Report </p>  </a></li><?php } ?>
                                                    ...
                                                    <li class="nav-item"><a href="rejection_inline_scan_report"  class="nav-link <?php if ($act == "rejection_inline_scan_report" or $act == "rejection_inline_scan_report_summary" or $act == "rejection_inline_scan_report_detailed") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Inline Rejection Scan Report </p>  </a></li><?php } ?>
                                                     ...
                                                     <?php if ($row->r21 == 1) { ?>   
                                                     <li class="nav-item"><a href="trans_order_report"  class="nav-link <?php 
                                                     if ($act == "trans_order_report"or $act == "trans_order_report_summary" or $act == "trans_order_report_detailed") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer Order Report </p>  </a></li><?php } ?>
                                                       
                                                    <?php if ($row->r3 == 1) { ?>   
                                                     <li class="nav-item"><a href="transfer_entry_report"  class="nav-link <?php if ($act == "transfer_entry_report" or $act == "transfer_entry_report_summary" or $act == "transfer_entry_report_detailed" or $act == "transfer_entry_report_itemwise") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Transfer Entry Report </p>  </a></li><?php } ?>
   
                                                          
                                                               
                                                    <?php if ($row->r23 == 1) { ?>   
                                                     <li class="nav-item"><a href="opening_stock_report"  class="nav-link <?php if ($act == "opening_stock_report" or $act == "opening_stock_summary" or $act == "opening_stock_detailed" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Opening Stock Report </p>  </a></li><?php } ?>
                                                     
                                                      <?php if ($row->r24 == 1) { ?>   
                                                     <li class="nav-item"><a href="transfer_receipt_report"  class="nav-link <?php if ($act == "transfer_receipt_report" or $act == "trans_receipt_report_summary" or $act=="trans_receipt_report_itemwise" or $act == "trans_receipt_report_detailed" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Trans Receipt Report </p>  </a></li><?php } ?>
   
                                                          
                                                             <?php if ($row->r25 == 1) { ?>   
                                                     <li class="nav-item"><a href="sales_return_report"  class="nav-link <?php if ($act == "sales_return_report" or $act == "sales_return_report_summary" or $act=="sales_return_report_itemwise" or $act == "tsales_return_report_detailed" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Sales Return Report </p>  </a></li><?php } ?>
   
                                                          
                                                             <?php if ($row->r29 == 1) { ?>   
                                                     <li class="nav-item"><a href="stockout_report"  class="nav-link <?php if ($act == "stockout_report" or $act == "stockout_report_summary" or $act == "stockout_report_detailed" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;Stockout Report </p>  </a></li><?php } ?>
                                                        
                                                         <?php if ($row->r40 == 1) { ?>   
                                                     <li class="nav-item"><a href="nav_detail_report"  class="nav-link <?php if ($act == "nav_detail_report" or $act == "nav_detail_report_summary" or $act == "nav_detail_report_detailed" ) { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;&nbsp;NAV Details Report </p>  </a></li><?php } ?>
                                        ...
                                        if ($act == "permission" or $act == "addpermission" or $act == "changepassword" or $act == "opening_stock" or $act == "reprint" or $act == "direct_opening_stock") {
                                            $cls = 4;
                                        }
                                        if ($row->p1 == 1 or $row->p2 == 1 or $row->p3 == 1 or $row->p4 == 1 or $row->p5 == 1) {
                                            ?>
                                                ...
                                                <ul class="nav nav-treeview p-1 " >
                                                    ...
                                                    <?php if ($row->p2 == 1) { ?>
                                                        ...
                                                        <li class="nav-item " ><a href="opening_stock"  class="nav-link <?php if ($act == "opening_stock") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;Opening Stock</p>  </a></li><?php } ?>
														 ...
														 <?php if ($row->p5 == 1) { ?>
                                                        <li class="nav-item " ><a href="direct_opening_stock"  class="nav-link <?php if ($act == "direct_opening_stock") { ?>active<?php } ?>"> <i class="fa fa-chevron-circle-right"></i> <p style="font-size:14px">&nbsp;Direct Opening Stock</p>  </a></li><?php } ?>
...
//	    break; 
						...
						//Sub Category master
							...
							//receipe master
								case "labeltemplate":
                                    if ($row->m10 == 1) {
                                        include("labelprint_template.php");
                                    }
                                    break;
                           ...
                           /*     case "barcodegen":
                                ...
                                case "Routecard_entry":
                                    ...
                                    break;
                                       ...
                                       case "Material_Req_Entry":
                                    if ($row->i3 == 1) {
                                        include("material_req_entry.php");
                                    }
                                    break;
...
*/
							  ...
							  case "dispatch_manual_close":
                                    ...
                                    break;
                                     ...
                                     case "transfer_order_entry":
                                    if ($row->i13 == 1) {
                                        include("transfer_order_entry.php");
                                    }
                                    break;

                                    case "rpo_item_cancel":
                                    if ($row->i15 == 1) {
                                        include("rpo_item_cancel.php");
                                    }
                                    break;

                                    case "rpo_item_cancel_list":
                                    if ($row->i15 == 1) {
                                        include("rpo_item_cancel_list.php");
                                    }
                                    break;



                                    case "sale_order_item_cancel":
                                    if ($row->i16 == 1) {
                                        include("sale_order_item_cancel.php");
                                    }
                                    break;

                                    case "sale_order_item_cancel_list":
                                    if ($row->i16 == 1) {
                                        include("sale_order_item_cancel_list.php");
                                    }
                                    break;
									
									 case "transfer_receipt":
                                    if ($row->i15 == 1) {
                                        include("transfer_receipt_entry.php");
                                    }
                                    break;



                                    case "transfer_order_item_cancel":
                                    if ($row->i18 == 1) {
                                        include("transfer_order_item_cancel.php");
                                    }
                                    break;

                                    case "transfer_order_item_cancel_list":
                                    if ($row->i18 == 1) {
                                        include("transfer_order_item_cancel_list.php");
                                    }
                                    break;

                                    

                                    case "sales_return_entry":
                                    if ($row->i19 == 1) {
                                        include("sales_return_entry.php");
                                    }
                                    break;
                                ...
                                case "grn_report_detailed":
                                    ...
                                    break;
                                             ...
                                             case "material_req_report":
                                    if ($row->r4 == 1) {
                                        include("material_req_report.php");
                                    }
                                    break;

                                case "material_req_report_summary":
                                    if ($row->r4 == 1) {
                                        include("material_req_report_summary.php");
                                    }
                                    break;

                                case "material_req_report_detailed":
                                    if ($row->r4 == 1) {
                                        include("material_req_report_detailed.php");
                                    }
                                    break;



                                case "general_material_issue_report":
                                    if ($row->r16 == 1) {
                                        include("general_material_issue_report.php");
                                    }
                                    break;

                                case "general_material_issue_report_summary":
                                    if ($row->r16 == 1) {
                                        include("general_material_issue_report_summary.php");
                                    }
                                    break;

                                case "general_material_issue_report_detailed":
                                    if ($row->r16 == 1) {
                                        include("general_material_issue_report_detailed.php");
                                    }
                                    break;

                                       case "general_material_issue_picklist":
                                    if ($row->r16 == 1) {
                                        include("routecard_requisition_picklist.php");
                                    }
                                    break;

//general_material_issue_scan_report

                                case "general_material_issue_scan_report":
                                    if ($row->r26 == 1) {
                                        include("general_material_issue_scan_report.php");
                                    }
                                    break;

                                case "general_material_issue_scan_report_summary":
                                    if ($row->r26 == 1) {
                                        include("general_material_issue_scan_report_summary.php");
                                    }
                                    break;

                                case "general_material_issue_scan_report_detailed":
                                    if ($row->r26 == 1) {
                                        include("general_material_issue_scan_report_detailed.php");
                                    }
                                    break;


                             //general_material_item_return_report

                                case "general_material_item_return_report":
                                    if ($row->r28 == 1) {
                                        include("general_material_item_return_report.php");
                                    }
                                    break;

                                case "general_material_item_return_report_summary":
                                    if ($row->r28 == 1) {
                                        include("general_material_item_return_report_summary.php");
                                    }
                                    break;

                                     case "general_material_item_return_report_itemwise":
                                    if ($row->r28 == 1) {
                                        include("general_material_item_return_report_itemwise.php");
                                    }
                                    break;

                                case "general_material_item_return_report_detailed":
                                    if ($row->r28 == 1) {
                                        include("general_material_item_return_report_detailed.php");
                                    }
                                    break;
                                 case "general_material_item_return_report_navsend":
                                    if ($row->r28 == 1) {
                                        include("ws_general_item_return_scan_nav_uploader.php");
                                    }
                                    break;
                                   ...
                                   // purchase_return_report
                                    ...
                                    if ($row->r30 == 1) {
                                        include("purchase_return_report.php");
                                    }
                                    break;

                                     case "purchase_return_report_summary":
                                    if ($row->r30 == 1) {
                                        include("purchase_return_report_summary.php");
                                    }
                                    break;
                                    case "purchase_return_report_detailed":
                                    if ($row->r30 == 1) {
                                        include("purchase_return_report_detailed.php");
                                    }
                                    break;
    ...
    //Bin to bin transfer
                               ...
                               // nav_detail_report
                                ...
                                case "nav_detail_report":
                                    if ($row->r40 == 1) {
                                        include("nav_detail_report.php");
                                    }
                                    break;

                                case "nav_detail_report_summary":
                                    if ($row->r40 == 1) {
                                        include("nav_detail_report_summary.php");
                                    }
                                    break;

                                case "nav_detail_report_detailed":
                                    if ($row->r40 == 1) {
                                        include("nav_detail_report_detailed.php");
                                    }
                                    break;
...
/*
                              ...
                              //opening stock report // 
                                     ...
                                     case "opening_stock_report":
                                    if ($row->r23 == 1) {
                                        include("opening_stock_report_sel.php");
                                    }
                                    break;

                                  case "opening_stock_summary":
                                    if ($row->r23 == 1) {
                                        include("opening_stock_summary.php");
                                    }
                                    break;

                                    case "opening_stock_detailed":
                                    if ($row->r23 == 1) {
                                        include("opening_stock_detailed.php");
                                    }
                                    break;
							...
							//inline rejection report
							 ...
							 case "rejection_inline_scan_report":
                                ...
                                case "material_issue_report_detailed":
                                    ...
                                    /*transfer entry picklist*/
                                    case "transfer_entry_report":
                                    if ($row->r3 == 1){
                                        include("transfer_entry_report.php");
                                    }
                                    break;
                                    case "transfer_entry_report_summary":
                                    if ($row->r3 == 1){
                                        include("transfer_entry_report_summary.php");
                                    }
                                    break;
                                    case "transfer_entry_report_detailed":
                                    if ($row->r3 == 1){
                                        include("transfer_entry_report_detailed.php");
                                    }
                                    break;
                                    case "transfer_entry_report_itemwise":
                                    if ($row->r3 == 1){
                                        include("transfer_entry_report_itemwise.php");
                                    }
                                    break;
                                    case "transfer_picklist":
                                    if ($row->r3 == 1){
                                        include("transfer_picklist_view.php");
                                    }
                                    break;
							 ...
							 case "material_issue_pendg_report":
                                ...
                                case "material_issue_pendg_report_detailed":
                                    ...
                                    break;
									 ...
									 case "trans_order_report":
                                    if ($row->r21 == 1) {
                                        include("trans_order_report.php");
                                    }
                                    break;

                                case "trans_order_report_summary":
                                    if ($row->r21 == 1) {
                                        include("trans_order_report_summary.php");
                                    }
                                    break;

                                case "trans_order_report_detailed":
                                    if ($row->r21 == 1) {
                                        include("trans_order_report_detailed.php");
                                    }
                                    break;
									 ...
									 case "transfer_receipt_report":
                                    if ($row->r24 == 1) {
                                        include("trans_receipt_report_sel.php");
                                    }
                                    break;

                                case "trans_receipt_report_summary":
                                    if ($row->r24 == 1) {
                                        include("trans_receipt_report_summary.php");
                                    }
                                    break;
								 case "trans_receipt_report_itemwise":
                                    if ($row->r24 == 1) {
                                        include("trans_receipt_report_itemwise.php");
                                    }
                                    break;	
									

                                case "trans_receipt_report_detailed":
                                    if ($row->r24 == 1) {
                                        include("trans_receipt_report_detailed.php");
                                    }
                                    break;
								...
								case "sales_return_report":
                                    if ($row->r24 == 1) {
                                        include("sales_return_report_sel.php");
                                    }
                                    break;

                                case "sales_return_report_summary":
                                    if ($row->r24 == 1) {
                                        include("sales_return_report_summary.php");
                                    }
                                    break;
								 case "sales_return_report_itemwise":
                                    if ($row->r24 == 1) {
                                        include("sales_return_report_itemwise.php");
                                    }
                                    break;	
									

                                case "sales_return_report_detailed":
                                    if ($row->r24 == 1) {
                                        include("sales_return_report_detailed.php");
                                    }
                                    break;
                                ...
                                case "stockout_report":
                                    if ($row->r29 == 1) {
                                        include("stockout_report_select.php");
                                    }
                                    break;


                                case "stockout_report_summary":
                                    if ($row->r29 == 1) {
                                        include("stockout_report_summary.php");
                                    }
                                    break;


                                case "stockout_report_detailed":
                                    if ($row->r29 == 1) {
                                        include("stockout_report_detailed.php");
                                    }
                                    break;
								...
								case "direct_opening_stock":
                                    if ($row->p5 == 1) {
                                        include("direct_opening_stock.php");
                                    }
                                    break;
