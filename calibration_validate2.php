...
$res_ftp1 = db_query($sql_ftp);

$ftp_data = db_fetch_object($res_ftp1);
    ...
    $ftp_folder = $ftp_data->SO_PATH;
        ...
        if($errmsg){
                  ...
                  header("location:cam?&errmsg=$errmsg&page=$page&barcode=$barcode");
                  ...
                  header("location:cam?&msg=$msg&page=$page&barcode=$barcode");
