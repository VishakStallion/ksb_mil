<html><form id="form1" name="form1" method="post" enctype="multipart/form-data">
    <input type="file" class="formcontent file" name="dispatch_file"  style="border:1px solid"/>
...
if(!isset($_POST['submit'])){
	...
	$file_to_include = $_FILES['dispatch_file']['tmp_name'];
}
